function initRippleHover() {
  // get all [data-profile elements]
  const navItems = document.querySelectorAll("[data-profile]");

  // Helper function to add/remove a class to a sibling at a given offset 
  // help from OSMO supply free resource
...
// Initialize Ripple Hover interaction
